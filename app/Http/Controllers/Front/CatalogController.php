...
class CatalogController extends Controller
{
	...
	public function index(Request $request)
	{
        ...
        // dd(Category::with('subcategory')->whereStatus(1)->orderby('serial','asc')->withCount(['items' => function($query) {
        ...
        return view($blade,[
            ...
            'categories_all' => Category::whereStatus(1)->orderby('serial','asc')->withCount(['items' => function($query) {
                $query->where('status',1);
            }])->get(),
        ]);
	}
