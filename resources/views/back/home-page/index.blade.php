                            ...
                            <form class="admin-form" action="{{route('back.hero.banner.update')}}"method="POST" enctype="multipart/form-data">
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img1']) ? url('/storage/images/'.$hero_banner['img1']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img2']) ? url('/storage/images/'.$hero_banner['img2']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$first_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$first_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$first_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.secend.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$secend_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$secend_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$secend_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.third.banner.update')}}"
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$third_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  url('/storage/images/'.$third_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.home_page4.banner.update')}}"method="POST" enctype="multipart/form-data">
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img1']) ?  url('/storage/images/'.$home4_banner['img1']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img2']) ?  url('/storage/images/'.$home4_banner['img2']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img3']) ?  url('/storage/images/'.$home4_banner['img3']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img4']) ?  url('/storage/images/'.$home4_banner['img4']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img5']) ?  url('/storage/images/'.$home4_banner['img5']) : url('/storage/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
