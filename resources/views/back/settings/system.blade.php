                                                                        ...
                                                                        <div class="col-lg-12 ">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img"
                                                                                        src="{{ $setting->logo ? asset('storage/images/' . $setting->logo) : asset('storage/images/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                ...
                                                <div id="google_recaptcha" class="tab-pane"><br>
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <!-- Facebook Conversions API (CAPI) settings -->
                                                            <hr>
                                                            ...
                                                            <div class="form-group">
                                                                <label>{{ __('Facebook CAPI Pixel ID') }} *</label>
                                                                <input type="text" name="facebook_capi_pixel_id" class="form-control" placeholder="{{ __('Facebook Pixel ID') }}" value="{{ $setting->facebook_capi_pixel_id }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label>{{ __('Facebook CAPI Access Token') }} *</label>
                                                                <textarea name="facebook_capi_access_token" class="form-control" placeholder="{{ __('Access Token') }}">{{ $setting->facebook_capi_access_token }}</textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <label>{{ __('Facebook CAPI Test Event Code') }}</label>
                                                                <input type="text" name="facebook_capi_test_event_code" class="form-control" placeholder="{{ __('Test Event Code') }}" value="{{ $setting->facebook_capi_test_event_code }}">
                                                            </div>
                                                            ...
                                                            <hr>
                                                                ...
                                                                <div class="form-group">
                                                                    <form action="{{ route('back.setting.facebook_capi.test') }}" method="POST">
                                                                        @csrf
                                                                        <button type="submit" class="btn btn-primary">{{ __('Send Test CAPI Event') }}</button>
                                                                        <small class="form-text text-muted">{{ __('Dispatches a small test event to Facebook CAPI using the configured Pixel ID & Access Token.') }}</small>
                                                                    </form>
                                                                </div>
                                                                ...
                                                                <div id="footer_basic" class="container tab-pane active">
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="whatsapp_number">{{ __('WhatsApp Number') }}
                                                                                    </label>
                                                                                ...
                                                                                <small class="form-text text-muted">{{ __('Enter WhatsApp number with country code (e.g., +1234567890). Leave empty to use Store Phone Number.') }}</small>
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="whatsapp_message">{{ __('WhatsApp Default Message') }}
                                                                                    </label>
                                                                                <textarea name="whatsapp_message"
                                                                                    class="form-control" id="whatsapp_message" rows="3"
                                                                                    placeholder="{{ __('Enter default WhatsApp message') }}">{{ $setting->whatsapp_message ?? 'Hello, I need help with your products' }}</textarea>
                                                                                <small class="form-text text-muted">{{ __('This message will be pre-filled when customers click the WhatsApp button.') }}</small>
                                                                            </div>

                                                                            <div class="form-group">
                                                                                <label for="is_whatsapp_enabled">{{ __('WhatsApp Chat Button') }}</label>
                                                                                    <input type="checkbox" name="is_whatsapp_enabled"
                                                                                    value="1" {{ ($setting->is_whatsapp_enabled ?? 1) ? 'checked' : '' }}>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img"
                                                                                        src="{{ $setting->footer_gateway_img ? url('/storage/images/' . $setting->footer_gateway_img) : url('/storage/images/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
