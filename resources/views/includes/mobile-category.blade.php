...
@php
    $mobileCategories = App\Models\Category::with('subcategory','subcategory.childcategory')->whereStatus(1)->orderby('serial','asc')->take(8)->get();
@endphp


<div class="widget-categories mobile-cat">
    <ul id="category_list">
        @foreach ($mobileCategories as $getcategory)
