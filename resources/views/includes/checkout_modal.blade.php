     ...
     <div class="modal fade" id="paypal" tabindex="-1" aria-hidden="true">
         <form class="interactive-credit-card row" action="{{ url(route('front.checkout.submit')) }}" method="POST">
             @csrf
             <div class="modal-dialog">
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <div class="card-body">
                         ...
                         <form class="interactive-credit-card row" action="{{ url(route('front.checkout.submit')) }}"
                             method="POST">
                             @csrf
     ...
     @php
         $paymentData = $payment_settings['mercadopago'] ?? null;
         $paydata = $paymentData ? json_decode($paymentData->information, true) : [];
     @endphp
     ...
     <div class="modal fade" id="paystack" tabindex="-1" aria-hidden="true">
         ...
         @php
             $data = $payment_settings['paystack'] ?? null;
             $paydata = $data ? json_decode($data->information, true) : [];
