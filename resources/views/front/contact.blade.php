            ...
            <li><span class="text-muted">{{__('Saturday')}}:</span>{{$setting->satureday_start}} - {{$setting->satureday_end}}</li>
                ...
                <section class="widget widget-featured-posts card rounded p-4">
                    ...
                    <ul class="list-icon margin-bottom-1x">
                        <li> <i class="icon-map-pin"></i><span>{{ $setting->footer_address }}</span></li>
                        <li> <i class="icon-phone"></i><span>{{ $setting->footer_phone }}</span></li>
                    </ul>
                    ...
                    <div>
                        @foreach ($links as $link_key => $link)
                            <a class="social-button shape-circle sb-facebook" href="{{ $link }}"
                                data-toggle="tooltip" data-placement="top"><i class="{{ $icons[$link_key] }}"></i></a>
                        @endforeach
                    </div>
                </section>
            </div>
                    ...
                    @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-rounded" type="email" name="email"
                                    id="contact-email" placeholder="{{ __('E-mail') }}">
                                @error('email')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-rounded" type="text" name="phone"
                                    id="contact-tel" placeholder="{{ __('Phone') }}">
                                @error('phone')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-12  ">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-rounded" rows="9" name="message" id="message-text"
