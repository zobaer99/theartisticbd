...
.list-icon > li > i,
.auth-form-card .login-icon,
.side-video-list .video-top-title,
.other-page-data .page-card-title,
.faq-tab-content-wrap .nav-pills .nav-item.show .nav-link,
.faq-tab-content-wrap .nav-pills .nav-link.active,
...
.toprated-slider.owl-carousel .owl-nav div:hover,
.product-dt-form-group input[type="radio"]:checked + .form-check-button,
.btn,
.footer-social-links a,
.a2a_kit a,
.deal-of-day-section .right-area,
...
.payment-shipping-option-wrap input[type="radio"]:checked + .option,
.product-dt-form-group input[type="radio"]:checked + .form-check-button,
